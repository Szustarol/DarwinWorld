...
public class Translations {
    private static TreeMap<String, String> translations;
    ...
    private static final String [] names = {"n_animals", "map_width", "map_height", "jungle_percent", "food_value", "food_decay",
    ...
    private static final String [] tr_pl_PL = {"Początkowa liczba zwierząt", "Szerokość mapy", "Wysokość mapy", "Procentowy rozmiar dżungli",
    ...
    private static final String [] tr_en_EN = {"Starting number of animals", "Map width", "Map height", "Jungle percentage",
    "Food energy value", "Daily energy decrease", "Apply config", "Reset config", "Initial setup", "Engine settings",
